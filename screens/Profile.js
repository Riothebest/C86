        ...
        <View style={styles.container}>
          ...
          <View style={styles.screenContainer}>
            ...
            <View style={styles.themeContainer}>
              ...
              <Switch style={{transform:[{scaleX:1.3},{scaleY:1.3}]}} trackColor={{false:"#767577",true:"white"}}
               thumbColor={this.state.isEnabled ? "#ee8249" : "#f4f3f4"} ios_backgroundColor="#3e3e3e"
